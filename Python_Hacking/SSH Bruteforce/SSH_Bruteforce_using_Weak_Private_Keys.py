# -*- coding: utf-8 -*-
"""For using the attack you need to download SSH weakKeys from the link:
   For 1024:http://digitaloffense.net/tools/debian-openssl/debian_ssh_dsa_1024_x86.tar.bz2
   or visit website: http://digitaloffense.net/tools/debianopenssl/
   """

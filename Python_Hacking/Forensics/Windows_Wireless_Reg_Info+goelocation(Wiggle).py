""" It requires mechanize library and a wiggle account, parse wiglle username and password as arguments from
    commandline(see usage from help). Its will provide the Wifi Access Points details and their geo-location
    if present on the wiggle database."""
